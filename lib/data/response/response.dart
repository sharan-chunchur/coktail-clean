...
class DrinksListResponse {
  List<DrinksResponse>? drinks;

  DrinksListResponse({this.drinks});

  DrinksListResponse.fromJson(Map<String, dynamic> json) {
    if (json['drinks'] != null) {
      drinks = <DrinksResponse>[];
      json['drinks'].forEach((v) {
        drinks!.add(DrinksResponse.fromJson(v));
      });
    }
  }
...
class DrinksResponse {
  ...
  DrinksResponse({this.strDrink, this.strDrinkThumb, this.idDrink});

  DrinksResponse.fromJson(Map<String, dynamic> json) {
...
class DrinkDetailsListResponse {
  List<DrinkDetailResponse>? drinks;

  DrinkDetailsListResponse({this.drinks});

  DrinkDetailsListResponse.fromJson(Map<String, dynamic> json) {
    if (json['drinks'] != null) {
      drinks = <DrinkDetailResponse>[];
      json['drinks'].forEach((v) {
        drinks!.add(DrinkDetailResponse.fromJson(v));
      });
    }
  }
...
class DrinkDetailResponse {
  ...
  DrinkDetailResponse.fromJson(Map<String, dynamic> json) {
    idDrink = json['idDrink'];
    strDrink = json['strDrink'];
